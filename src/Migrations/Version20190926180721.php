 ...
 */
final class Version20190926180721 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD plain_password VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
